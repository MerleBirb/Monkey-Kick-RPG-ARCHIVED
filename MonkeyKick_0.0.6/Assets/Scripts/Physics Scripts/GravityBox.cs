...
{
    /// GRAVITY BOX (GRAVITY SOURCE) ///
    /// a type of gravity that works like a box, inside and out!
    /// haha, again, thank you @Catlike Coding! 10/14/2020

    /// VARIABLES ///
    // here it is folks, the gravity
    [SerializeField]
    private float gravity = 9.81f;
    // boundary box for the gravity
    [SerializeField]
    private Vector3 boundaryDistance = Vector3.one;
    // the outer boundary for the gravity of the box
    [SerializeField, Min(0f)]
    private float outerDistance = 0f, outerFallOffDistance = 0f;
    // the inner boundary box, for the inside of boxes
    [SerializeField, Min(0f)]
    ...
    /// GetGravityComponent helps the box tell which face you're standing on
    ...
    /// OnValidate keeps the box in check
    ...
    /// DrawGizmosRect is special for the gravity box
